...
def generate_sql_sync(
    ...
    system_lines = [
        ...
        "  - STEP 2: Call the stored procedure with required parameters: EXEC dbo.SIS_Students_GetStudentDetailsByUserId @UserId = @UserId, @StudentStatusID = NULL, @GenderListId = NULL;",
        "  - IMPORTANT: Always include @StudentStatusID = NULL and @GenderListId = NULL in the EXEC call — they are required parameters by the stored procedure.",
